...
def _get_snyk_tags(snyk_group_id: str, snyk_api_key: str,
                   page_number: int, tags: list = []):
    page_size: int = 1000
    response: Response = _get_snyk_tag_page(
        snyk_group_id, snyk_api_key, page_number, page_size)
