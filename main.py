...
snyk_api_key = parameter_store.get_parameter(
    Name=f"/INFRA/security/{app_name}/snyk-api-key",
    WithDecryption=True)['Parameter']['Value']
snyk_group_id = parameter_store.get_parameter(
    Name=f"/INFRA/security/{app_name}/snyk-group-id")['Parameter']['Value']
